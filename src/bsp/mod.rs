...
use embassy_stm32::peripherals::{IWDG, I2C2, DMA1_CH4, DMA1_CH5, PA1, PA2, PB2, PC5};
...
pub struct EcospeakerV1<'a> {
    ...
    pub watchdog: IndependentWatchdog<'a, IWDG>,
}
...
impl EcospeakerV1<'static> {
    pub fn new(p: Peripherals) -> Self {
        ...
        let shared_i2c_bus: &mut Mutex<ThreadModeRawMutex, I2c<I2C2, DMA1_CH4, DMA1_CH5>> = I2C2_BUS.init(i2c2_bus);
